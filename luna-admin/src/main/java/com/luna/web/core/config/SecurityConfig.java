...
import com.luna.web.security.filter.JwtAuthenticationTokenFilter;
import com.luna.web.security.handle.AuthenticationEntryPointImpl;
import com.luna.web.security.handle.LogoutSuccessHandlerImpl;
...
public class SecurityConfig {
    ...
    @Configuration
    @Order(99)
    public static class RuoyiSecurityConfig extends WebSecurityConfigurerAdapter {
        /** 自定义用户认证逻辑 */
        ...
        @Bean
        @Primary
        public AuthenticationManager ruoyiAuthenticationManagerBean() throws Exception {
